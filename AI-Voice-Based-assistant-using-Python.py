...
if __name__ == "__main__":
    ...
    #logic for executing tasks based on query
        ...
        if 'open youtube' in query:
            ...
            speak("I have been created by lalith raju.")
            ...
            speak("Thanks to lalith raju. further It's a secret")

        elif 'is love' in query:
            speak("It is 7th sense that destroy all other senses")

        elif "who are you" in query:
            speak("I am your virtual assistant created by lalith raju)

        elif 'reason for creating you' in query:
            speak("I was created as a Minor project by Mister lalith raju ")
